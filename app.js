(() => {
  ...
  const SPECIAL_BELLS = {
    ...
    /* 9월 전국연합학력평가 · 대수능모의평가. 시험 교시와 감독 시수(수업시수)
       경계가 달라서 감독 배정 단위로 끊어 둔다. 각 칸은 감독표(9.2) 1·2학년
       열 기준이고, 감독이 없는 칸도 남겨야 다음 감독 시각이 제대로 뜬다. */
    '2026-09-02': {
      note: '9월 모의고사 · 감독 5시수(1·3·6·7·8)',
      slots: [
        { label: '1교시 · 204호 감독 (시수 1A)', start: '08:35', end: '09:10', kind: 'event' },
        { label: '1교시 · 감독 없음 (시수 2)', start: '09:10', end: '10:00', kind: 'event' },
        { label: '2교시 · 306호 감독 (시수 3)', start: '10:25', end: '11:20', kind: 'event' },
        { label: '2교시 · 감독 없음 (시수 4)', start: '11:20', end: '12:10', kind: 'event' },
        { label: '점심시간', start: '12:10', end: '13:15', kind: 'lunch' },
        { label: '3교시 · 감독 없음 (시수 5)', start: '13:15', end: '14:10', kind: 'event' },
        { label: '3교시 · 202호 감독 (시수 1B)', start: '14:10', end: '14:30', kind: 'event' },
        { label: '4교시 · 203호 감독 (시수 6)', start: '14:45', end: '15:40', kind: 'event' },
        { label: '4교시 · 203호 감독 (시수 7)', start: '15:40', end: '16:30', kind: 'event' },
        { label: '4교시 · 203호 감독 (시수 8)', start: '16:30', end: '17:10', kind: 'event' },
      ],
    },
    '2026-09-03': {
